...
const CalculatorResults = ({
  ...
  return (
    <div className="space-y-8">
      ...
      >
        <Card className="overflow-hidden transform hover:scale-[1.01] transition-all duration-300">
            ...
            <div className="space-y-6">
              <div className="pb-6 border-b border-orange-100">
                ...
                <div className="flex items-baseline justify-between">
                  <div className="text-3xl font-bold text-gray-900 bg-gradient-to-r from-orange-600 to-orange-500 bg-clip-text text-transparent">
